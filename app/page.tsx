...
export default function HomePage() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-background to-muted/50 py-20 px-4">
        <div className="container mx-auto max-w-7xl text-center">
          <div className="max-w-4xl mx-auto space-y-6">
            <Badge className="bg-aau-gold text-aau-blue hover:bg-aau-gold/90">🚀 Now Accepting Applications</Badge>

            <h1 className="text-4xl md:text-6xl font-bold text-balance">
              Transform Your <span className="aau-blue">Ideas</span> Into
              <span className="aau-gold"> Impactful Startups</span>
            </h1>

            <p className="text-xl text-muted-foreground text-pretty max-w-2xl mx-auto">
              Join AAU's premier startup incubation program. Get mentorship, resources, and funding to turn your
              innovative ideas into successful businesses.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button size="lg" asChild className="bg-aau-blue hover:bg-aau-blue/90">
                <Link href="/apply">
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center space-y-2">
              <div className="text-3xl font-bold aau-blue">150+</div>
              <div className="text-sm text-muted-foreground">Startups Launched</div>
            </div>
            <div className="text-center space-y-2">
              <div className="text-3xl font-bold aau-blue">50+</div>
              <div className="text-sm text-muted-foreground">Expert Mentors</div>
            </div>
            <div className="text-center space-y-2">
              <div className="text-3xl font-bold aau-blue">$2M+</div>
              <div className="text-sm text-muted-foreground">Funding Raised</div>
            </div>
            <div className="text-center space-y-2">
              <div className="text-3xl font-bold aau-blue">85%</div>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-7xl">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-3xl md:text-4xl font-bold">Why Choose AAU Startups Portal?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="border-2 hover:border-primary/20 transition-colors">
              <CardHeader>
                ...
                <CardDescription>Get guidance from industry experts and successful entrepreneurs</CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-2 hover:border-primary/20 transition-colors">
              <CardHeader>
                ...
                <CardDescription>Access to seed funding, grants, and investor networks</CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-2 hover:border-primary/20 transition-colors">
              <CardHeader>
                ...
                <CardDescription>Co-working spaces, legal support, and business development tools</CardDescription>
              </CardHeader>
            </Card>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="flex justify-between items-center mb-12">
            <div>
              ...
              <p className="text-muted-foreground">Discover innovative companies from our community</p>
            </div>
            ...
            {[1, 2, 3].map((i) => (
              <Card key={i} className="hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <CardDescription>Revolutionary mobile payment platform for rural Ethiopia</CardDescription>
                </CardHeader>
                <CardContent>
        ...
        <div className="container mx-auto max-w-7xl text-center">
          <div className="max-w-2xl mx-auto space-y-6">
            ...
            <p className="text-xl opacity-90">
              Join hundreds of entrepreneurs who have transformed their ideas into successful businesses
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" variant="secondary" asChild className="bg-aau-gold text-aau-blue hover:bg-aau-gold/90">
