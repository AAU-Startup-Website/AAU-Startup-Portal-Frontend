    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="bg-[#001529] text-white py-2 px-6 flex justify-between items-center text-xs">
        <div className="flex gap-4">
          ...
          <span className="flex items-center gap-1">
            <Mail size={12} /> portal@aau.edu.et
          </span>
        </div>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8 md:p-16">
          <div className="w-full max-w-sm space-y-8">
            ...
            <div className="text-center">
              ...
              <h1 className="text-3xl font-bold text-[#001529] tracking-tight">
                AAU STARTUPS
              </h1>
              <p className="text-[#6c757d] mt-2 font-medium uppercase text-xs tracking-[0.2em]">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  <Label
                    htmlFor="username"
                    className="text-xs font-bold text-[#0056b3] ml-1 uppercase"
                  >
                    Username
                  </Label>
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between items-center px-1">
                    <Label
                      htmlFor="password"
                      className="text-xs font-bold text-[#0056b3] uppercase"
                    >
                      Password
                    </Label>
                    <Link
                      href="/forgot-password"
                      className="text-[10px] font-bold text-slate-400 hover:text-[#0056b3] uppercase tracking-tighter"
                    >
                      Forgot?
                    </Link>
                  </div>
            ...
            <div className="text-center pt-4">
              <p className="text-sm text-slate-500 font-medium">
                ...
                <Link
                  href="/register"
                  className="text-[#0056b3] hover:underline font-bold"
                >
                  CREATE ACCOUNT
                </Link>
              </p>
