...
import { Eye, EyeOff, Mail, Lock, User, GraduationCap, Phone, Globe } from "lucide-react"
...
export default function RegisterPage() {
  ...
  const [role, setRole] = useState<"student" | "mentor" | "investor" | "admin">("student")
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const apiRole = role === 'investor' ? 'student' : role;
      await registerUser({
        username: username.trim(),
        email,
        password,
        profile: { bio: department, role: apiRole, skills: department },
      })
      router.push("/login")
    } catch (err: any) {
    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="bg-[#001529] text-white py-2 px-6 flex justify-between items-center text-xs">
        <div className="flex gap-4">
          ...
          <span className="flex items-center gap-1"><Mail size={12} /> info@aau.edu.et</span>
        </div>
      ...
      <div className="flex flex-1">
        ...
        <div className="hidden lg:block w-1/2 relative overflow-hidden">
          ...
          <div className="absolute bottom-20 left-12 text-white z-10 max-w-md">
            <h2 className="text-4xl font-bold mb-4 uppercase tracking-wider">Innovating the Future</h2>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8 md:p-12">
          <div className="w-full max-w-md space-y-6">
            <div className="text-center">
              ...
              <h1 className="text-2xl font-bold text-[#001529] tracking-tight">AAU STARTUPS</h1>
              <p className="text-[#6c757d] mt-1 font-medium uppercase text-[10px] tracking-[0.2em]">Institutional Registration Portal</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="space-y-1">
                  <Label htmlFor="username" className="text-[10px] font-bold text-[#0056b3] uppercase ml-1">Username</Label>
                ...
                <div className="space-y-1">
                  <Label htmlFor="email" className="text-[10px] font-bold text-[#0056b3] uppercase ml-1">Official Email</Label>
                  <div className="relative">
                ...
                <div className="space-y-1">
                  <Label htmlFor="department" className="text-[10px] font-bold text-[#0056b3] uppercase ml-1">Department</Label>
                  <div className="relative">
                ...
                <div className="space-y-1">
                  <Label htmlFor="password" className="text-[10px] font-bold text-[#0056b3] uppercase ml-1">Password</Label>
                  <div className="relative">
              ...
              <div className="grid grid-cols-4 gap-2">
                {['student', 'mentor', 'investor', 'admin'].map((r) => (
                  <button
                    key={r}
                    type="button"
                    onClick={() => setRole(r as any)}
                    className={`text-[9px] font-bold uppercase py-2 border rounded-full transition-all ${
                      role === r ? "bg-[#0056b3] border-[#0056b3] text-white shadow-md" : "bg-white text-slate-500 border-slate-200"
                    }`}
                  >
                    {r}
                  </button>
              ...
              <Button type="submit" className="w-full h-11 rounded-full bg-[#0056b3] hover:bg-[#003d82] text-white font-bold shadow-lg mt-2" disabled={isLoading}>
            ...
            <div className="text-center pt-2">
              <p className="text-xs text-slate-500 font-medium">
                Already have an account? <Link href="/login" className="text-[#0056b3] font-bold hover:underline">SIGN IN</Link>
              </p>
            </div>
          </div>
        </div>
